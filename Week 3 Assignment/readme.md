This folder contains a main file "app.js" which connects with Azure MongoDB database and gives user the option to add new Enterties or search within the database using any keywords.
